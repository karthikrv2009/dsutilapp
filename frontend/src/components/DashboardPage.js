...
const useStyles = makeStyles((theme) => ({
  ...
  tableHead: {
    backgroundColor: theme.palette.common.white, // Blue color
  },
  tableCellHead: {
  ...
  TableRow: {
    backgroundColor: "#7d7260", // Blue color
  },
  TableRowHead: {
    backgroundColor: "#7d7260", // Blue color
  },
...
const DashboardPage = () => {
  ...
  return (
    <div>
      ...
      <Container>
        <FormControl sx={{ minWidth: 300, margin: 1 }}>
          <InputLabel id="dbProfile-label" className={classes.inputLabel}>
            SysLink Profiles
          </InputLabel>
          <Select
            ...
            <Table>
              ...
              <TableBody>
                {Object.keys(dashboardData).length > 0 ? (
                  ...
                  <TableRow>
                    <TableCell colSpan={2} className={classes.tableCellBody}>
                      No data available
                    </TableCell>
                  </TableRow>
                )}
        ...
        <Grid container spacing={4}>
          ...
          <Grid item xs={12} md={6}>
            <Table>
              <TableHead className={classes.tableHead}>
                <TableRow>
                  <TableCell className={classes.tableCellHead} colSpan={5}>
                    MetaData Catalog
                  </TableCell>
                </TableRow>
                <TableRow>
